    ...
    <RootProvider>
      <html lang="en">
        <head>
          <meta
            name="description"
            content="Pomodoro master is an app that is easy to use and helps you to focus on your tasks. You can customize the app to your liking. Choose your aesthetic themes without hassle!"
          />
          <Title />
        </head>
        <Body>{children}</Body>
